            ...
            if($filesize < 2000000){
                ...
                if(empty($ImageTitle )||empty($ImageDesc)){
                    ...
                    if(!mysqli_stmt_prepare($stmt,$sql)){
                        ...
                        $sql = "INSERT INTO images (titleImage,imgFullName,orderImg) VALUES ();";
                        if(!mysqli_stmt_prepare($stmt,$sql)){
                            echo "SQL could not execute";
                        }else{
                            mysqli_stmt_bind_param($stmt,"ssss",$ImageTitle,$ImgFullName,$setImgOrder);

                            move_uploaded_file($fileTemp,$fileDestination);
                            header("Location: Teller.php?upload=success");
                        }
                    }
                }
